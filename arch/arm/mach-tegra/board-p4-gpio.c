...
static struct sec_gpio_cfg_st ventana_gpio_table[] = {
...
/*  {GPIO,  TEGRA_GPIO_PS3,		 GPIO_OUTPUT,	 GPIO_LEVEL_LOW  }, */
	...
	{GPIO,  TEGRA_GPIO_PI4,		 GPIO_OUTPUT,	 GPIO_LEVEL_HIGH  },
	...
	{GPIO,  TEGRA_GPIO_PA7,		 GPIO_INPUT,	 GPIO_LEVEL_LOW  },
...
static struct sec_slp_gpio_cfg_st ventana_sleep_gpio_table[] = {
...
/* extra sleep gpio setting. */
	...
	{YES,   TEGRA_GPIO_PA7,		 GPIO_INPUT,   GPIO_LEVEL_LOW },
	{YES,   TEGRA_GPIO_PU5,		 GPIO_OUTPUT,   GPIO_LEVEL_LOW },
...
#if !defined(CONFIG_MACH_SAMSUNG_P4WIFI)
	{YES,  TEGRA_GPIO_PT5,		 GPIO_INPUT, GPIO_LEVEL_LOW },
	{YES,  TEGRA_GPIO_PT6,		 GPIO_INPUT, GPIO_LEVEL_LOW },
#endif
};

void tegra_gpio_register_table(struct sec_gpio_table_st *gpio_table)
{
	gpio_table->init_gpio_table = ventana_gpio_table;
	gpio_table->n_init_gpio_table = ARRAY_SIZE(ventana_gpio_table);
	gpio_table->sleep_gpio_table = ventana_sleep_gpio_table;
	gpio_table->n_sleep_gpio_table = ARRAY_SIZE(ventana_sleep_gpio_table);
}
