...
static ssize_t tegra_kbc_keyshort_test(struct device *dev,
						struct device_attribute *attr,
						char *buf)
{
	int pressed = 0;

	pr_info("KBC: tegra_kbc_keyshort_test");
...
static DEVICE_ATTR(matrixkey_pressed, S_IRUGO,
				tegra_kbc_keyshort_test, NULL);
