...
static int stmpe1801_gpio_irq_set_type(struct irq_data *data, unsigned int type)
{
	struct stmpe1801_gpio *stmpe1801_gpio =
				irq_data_get_irq_chip_data(data);
	int offset = data->irq - stmpe1801_gpio->irq_base;
...
static void stmpe1801_gpio_irq_lock(struct irq_data *data)
{
	struct stmpe1801_gpio *stmpe1801_gpio =
				irq_data_get_irq_chip_data(data);
...
static void stmpe1801_gpio_irq_sync_unlock(struct irq_data *data)
{
	int i, j;
	struct stmpe1801_gpio *stmpe1801_gpio =
				irq_data_get_irq_chip_data(data);
...
static void stmpe1801_gpio_irq_mask(struct irq_data *data)
{
	struct stmpe1801_gpio *stmpe1801_gpio =
				irq_data_get_irq_chip_data(data);
	int offset = data->irq - stmpe1801_gpio->irq_base;
...
static void stmpe1801_gpio_irq_unmask(struct irq_data *data)
{
	struct stmpe1801_gpio *stmpe1801_gpio =
				irq_data_get_irq_chip_data(data);
	int offset = data->irq - stmpe1801_gpio->irq_base;
...
static struct irq_chip stmpe1801_gpio_irq_chip = {
	.name                   = "stmpe1801_gpio",
	.irq_bus_lock               = stmpe1801_gpio_irq_lock,
	.irq_bus_sync_unlock        = stmpe1801_gpio_irq_sync_unlock,
	.irq_mask                   = stmpe1801_gpio_irq_mask,
	.irq_unmask                 = stmpe1801_gpio_irq_unmask,
	.irq_set_type               = stmpe1801_gpio_irq_set_type,
};
...
static int stmpe1801_gpio_irq_init(struct stmpe1801_gpio *stmpe1801_gpio)
{
	...
	for (irq = base; irq < base + stmpe1801_gpio->gpio_chip.ngpio; irq++) {
		irq_set_chip_data(irq, stmpe1801_gpio);
		irq_set_chip_and_handler(irq, &stmpe1801_gpio_irq_chip, handle_simple_irq);
